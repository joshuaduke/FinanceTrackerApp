        ...
        <div className="py-4 px-1 grid grid-cols-5 justify-center border-t-2 border-blue-900 w-full fixed bottom-0 left-0 right-0 ">
            <Link 
                ...
                <svg 
                    ...
                    height="24" 
                    viewBox="0 0 24 24">
                        <path fill="currentColor" d="M15 4H6v16h12V7h-3V4ZM6 2h10l4 4v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2Zm2 9h8v2H8v-2Zm0 4h8v2H8v-2Z"/>
                    </svg>
            ...
            <Link 
                ...
                <svg 
                    ...
                    height="24" 
                    viewBox="0 0 24 24">
                        <path fill="currentColor" d="M16 11q.425 0 .713-.288T17 10q0-.425-.288-.712T16 9q-.425 0-.712.288T15 10q0 .425.288.713T16 11ZM8 9h5V7H8v2ZM4.5 21q-.85-2.85-1.675-5.687T2 9.5q0-2.3 1.6-3.9T7.5 4h5q.725-.95 1.763-1.475T16.5 2q.625 0 1.063.438T18 3.5q0 .125-.125.575q-.1.275-.187.563t-.138.587L19.825 7.5H22v6.975l-2.825.925L17.5 21H12v-2h-2v2H4.5Z"/>
                    </svg>
